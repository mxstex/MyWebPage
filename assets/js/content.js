...
window.DATA = {
  ...
  gravityApps: [
    ...
    },
    {
      ...
      icon: "assets/img/gravity-3d-icon.png",
      desc: {
        en: "The 3D game on a phone: one finger aims, two fingers orbit the camera and pinch to zoom. Ten story chapters and thirteen free-play boards, including Jupiter's ladder of moons and the moving division in Saturn's ring. A golden-trace test proves the Kotlin engine flies the same trajectories as the Python one.",
        cs: "3D hra v telefonu: jeden prst míří, dva prsty otáčejí kameru a přibližují. Deset kapitol příběhu a třináct volných scén včetně žebříku Jupiterových měsíců a pohyblivé mezery v Saturnově prstenci. Golden-trace test ověřuje, že Kotlin engine letí po stejných drahách jako ten v Pythonu.",
      },
      links: [
  ...
  projects: [
    ...
    },
    {
      ...
      desc: {
        en: "A teaching simulator played from the control room: seven reactors and twenty scenarios, from the VVER-440 and the BN-600 fast reactor through Generation IV designs (BREST-OD-300, TMSR-LF1, HTR-PM) to the fuel cycle with the BN-800 and xenon oscillations in a VVER-1000. The lesson: control rods do not set power, they set reactivity; reactivity sets the rate of change, and power is only the consequence. Point kinetics with six delayed-neutron groups, a two-node thermal model, iodine and xenon, decay heat, a Fuchs–Nordheim excursion above prompt critical, protections and an automatic controller, grounded in my bachelor thesis on fast reactor cores. 46 physics and 32 learning tests; a how-to and a nine-part Reactor Physics series are on YouTube. Everything educational is free; Patreon unlocks free play.",
        cs: "Výukový simulátor hraný z velína: sedm reaktorů a dvacet scénářů, od VVER-440 a rychlého reaktoru BN-600 přes Generaci IV (BREST-OD-300, TMSR-LF1, HTR-PM) po palivový cyklus s BN-800 a xenonové oscilace ve VVER-1000. Lekce: regulační tyče nenastavují výkon, nastavují reaktivitu; reaktivita určuje rychlost změny a výkon je až důsledek. Bodová kinetika se šesti skupinami zpožděných neutronů, dvouuzlový tepelný model, jód a xenon, zbytkové teplo, Fuchsův–Nordheimův exkurz nad okamžitou kritičností, ochrany a automatický regulátor, opřené o mou bakalářskou práci o aktivních zónách rychlých reaktorů. 46 fyzikálních a 32 výukových testů; na YouTube je návod a devítidílný seriál Reactor Physics. Vše výukové je zdarma, volnou hru odemkne Patreon.",
      },
      links: [
        { label: { en: "Play in the browser", cs: "Hrát v prohlížeči" }, url: "links.reactorWeb", primary: true },
        { label: { en: "Video", cs: "Video" }, url: "https://www.youtube.com/watch?v=RKAmdtokFzg" },
        { label: { en: "Reactor Physics series", cs: "Seriál Reactor Physics" }, url: "https://www.youtube.com/watch?v=eGf_PoVpOo8" },
      ],
    },
    {
      name: "Fusion",
    ...
    },
    {
      ...
      links: [
        ...
        { label: { en: "Narrated guide", cs: "Návod s komentářem" }, url: "https://www.youtube.com/watch?v=do4Rt-59cpM" },
      ],
    },
    {
      name: "Tojin platform",
  ...
  changelog: [
    {
      ...
      items: {
        en: [
          "Tojin Forge is on YouTube: the card links the promo and the narrated guide, and describes the execution modes, Work mode, the model picker and the overnight runs that keep a change only when the repository's own tests pass.",
          "Reactor Operator: seven reactors and twenty scenarios, including Generation IV, the fuel cycle and xenon oscillations; links to the how-to video and the Reactor Physics series.",
          "Jednota: current size (more than 80,000 lines of Python, 1,400 tests) and the online multiplayer version in development.",
          "Gravity 3D for Android has thirteen free-play boards, not ten. The CV, the chat facts and the LinkedIn draft follow these changes.",
        ],
        cs: [
          "Tojin Forge je na YouTube: karta odkazuje na promo a návod s komentářem a popisuje režimy oprávnění, pracovní režim, výběr modelu a noční běhy, které změnu ponechají, jen když projdou testy daného repozitáře.",
          "Reactor Operator: sedm reaktorů a dvacet scénářů včetně Generace IV, palivového cyklu a xenonových oscilací; odkazy na video s návodem a seriál Reactor Physics.",
          "Jednota: aktuální rozsah (přes 80 000 řádků Pythonu, 1 400 testů) a online multiplayerová verze ve vývoji.",
          "Gravity 3D pro Android má třináct volných scén, ne deset. CV, fakta pro chat a LinkedIn profil odpovídají těmto změnám.",
        ],
      },
    },
    {
