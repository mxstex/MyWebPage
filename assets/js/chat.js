...
- Jednota: a 4X galactic strategy game and his largest project (more than 80,000 lines of Python, more than 1,400 tests, more than 300 logged design decisions). An invasion is coming from beyond the galaxy; the races unify the galaxy by diplomacy or conquest, then must destroy the invasion fleet. Three layers of AI agents on a local LLM through Ollama: a strategist per empire, an envoy per AI government and an admiral per fleet. Deterministic rules validate every model decision; in a measured five-empire campaign they accepted 93 of 93 strategic, 80 of 88 diplomatic and 79 of 86 tactical decisions. Agents remember earlier games through a pgvector store of chronicles, and recorded decisions let replays run without the model. In development, not publicly playable. An online version, Jednota forever online, is in development: a persistent real-time multiplayer galaxy on FastAPI, PostgreSQL and Vue 3, where a galaxy clock moves time for all players at once, with first contact, fleet battles, sieges, blockades and treaties between players; not deployed yet.
