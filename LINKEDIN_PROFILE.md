...
- Developed an Energy Management System consolidating and analysing data from multiple sources.
- Built Python backend services using Flask/FastAPI, PostgreSQL, RabbitMQ and Docker.
- Implemented ARIMA and SARIMA time-series forecasting.
- Built operational and management reporting with Grafana and Power BI.
- Mentored junior developers and contributed to architecture decisions.

### ABB s.r.o. — Software Project Engineer
Oct 2018 – Jan 2021

- Developed systems for monitoring and evaluating water and energy consumption.
- Built Python services and PostgreSQL data models.
- Used Azure Functions and Blob Storage for cloud processing.
- Developed operational dashboards in Grafana and Power BI.
- Added predictive analytics for resource optimisation.

### DISTEP a.s. — IT Specialist / Power Engineer / Technical Deputy
May 2010 – Oct 2018

- Worked across IT, data systems and energy distribution operations.
- Designed and maintained MS SQL-based operational data workflows and VBA automation.
- Improved resource efficiency through monitoring and calculation optimisation.
...
### Cloud and DevOps
Azure Container Apps, Azure Container Registry, Azure Key Vault, managed identity, Log Analytics, Azure DevOps / Pipelines, Docker, GCP Cloud Run, Secret Manager, Terraform.

### Earlier experience
LangChain, LangGraph, Dagster, Airflow, DuckDB, BigQuery, RabbitMQ, Kubernetes, GitLab CI, GitHub Actions, Flask, Streamlit, AWS S3 / Lambda, Azure Functions, Grafana, Power BI, ARIMA / SARIMA.

## Education

- Ing. (MSc), Electrical Engineering and Computer Science — VŠB – Technical University of Ostrava, 2012.
- Bc., Nuclear Engineering — Czech Technical University in Prague, Faculty of Nuclear Sciences and Physical Engineering, 2009.
- Research project — Institute of Plasma Physics, Czech Academy of Sciences, CASTOR tokamak, 2006.
- Cambridge English: First (FCE), Grade B, CEFR B2, 2019.
